...
namespace MangaRestaurant.Repository.Data.Migrations
{
    ...
    [Migration("20260420114510_GachaSystemIntegration")]
    partial class GachaSystemIntegration
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MangaRestaurant.Core.Entities.GachaPrize", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MangaRestaurant.Core.Entities.SiteSettings", b =>
                {
                    ...
                    b.Property<bool>("IsGachaEnabled")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("MangaRestaurant.Core.Entities.UserGachaReward", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("GachaPrizeId");

                    b.ToTable("UserGachaRewards");
                });

            modelBuilder.Entity("MangaRestaurant.Core.Entities.WishlistItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.OwnsOne("MangaRestaurant.Core.Entities.Order.OrderAddress", "ShippingAddress", b1 =>
                        {
                            ...
                            b1.Property<string>("LocationUrl")
                                .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("MangaRestaurant.Core.Entities.UserGachaReward", b =>
                {
                    b.HasOne("MangaRestaurant.Core.Entities.GachaPrize", "GachaPrize")
                        .WithMany()
                        .HasForeignKey("GachaPrizeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("GachaPrize");
                });
