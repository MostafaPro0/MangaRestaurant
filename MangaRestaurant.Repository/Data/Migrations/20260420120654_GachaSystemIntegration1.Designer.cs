...
namespace MangaRestaurant.Repository.Data.Migrations
{
    ...
    [Migration("20260420120654_GachaSystemIntegration1")]
    partial class GachaSystemIntegration1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MangaRestaurant.Core.Entities.LuckyPrize", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MangaRestaurant.Core.Entities.SiteSettings", b =>
                {
                    ...
                    b.Property<bool>("IsLuckyRewardsEnabled")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("MangaRestaurant.Core.Entities.UserLuckyReward", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("LuckyPrizeId");

                    b.ToTable("UserLuckyRewards");
                });
            ...
            modelBuilder.Entity("MangaRestaurant.Core.Entities.UserLuckyReward", b =>
                {
                    b.HasOne("MangaRestaurant.Core.Entities.LuckyPrize", "LuckyPrize")
                        .WithMany()
                        .HasForeignKey("LuckyPrizeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("LuckyPrize");
                });
