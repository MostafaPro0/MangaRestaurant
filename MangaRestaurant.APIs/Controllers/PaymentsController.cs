...
namespace MangaRestaurant.APIs.Controllers
{
    public class PaymentsController : BaseApiController
    {
        ...
        public PaymentsController(IPaymentService paymentService, IMapper mapper, IStringLocalizer<SharedResource> localizer)
        {
        ...
        public async Task<ActionResult<CustomerBasketDTO>> CreateOrUpdatePaymentIntent(string basketId)
        {
            ...
            if (customerBasket is null) return BadRequest(new ApiResponse(400, _localizer["BASKET_ERROR"]));
